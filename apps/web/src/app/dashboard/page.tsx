...
export default function DashboardPage() {
  ...
  if (error)
    return <p className="auth-error">Error: {error.message}</p>;
    ...
    <>
      ...
      <div className="stat-grid">
        ...
        <div className="stat-card">
          ...
          <div
            className={`value ${netCashFlow >= 0 ? 'positive' : 'negative'}`}
          >
            $
      ...
      <div className="card">
        ...
        >
          Create a wallet to start tracking your finances. Then add
          transactions to see your spending and income.
        </p>
      </div>
    </>
  );
