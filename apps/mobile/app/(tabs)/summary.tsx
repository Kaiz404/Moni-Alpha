    ...
    >
      ...
      <View className="mb-4 rounded-2xl border border-border bg-card p-4">
        ...
        <Text className="mt-1 text-xs text-muted">
          Amounts remain separated by currency. Debt cash activity is
        ...
        {netWorth.length === 0 ? (
          ...
          netWorth.map((row) => (
            ...
            >
              ...
              <Text className="mt-1 text-xs text-muted">
                Cash {formatMinorAmount(row.cashMinor, row.currency)}{' '}
                · Owed to you{' '}
                {formatMinorAmount(row.receivableMinor, row.currency)}{' '}
                · You owe{' '}
