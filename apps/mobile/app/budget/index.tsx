        ...
        {managing ? (
          currencies.length === 0 ? (
            <Text className="py-8 text-center text-muted">
              Add a wallet before setting a cap.
            </Text>
          ) : (
          ...
          <FinanceState
            ...
            detail="Set a cap or add a categorized expense to get started."
          />
        ) : (
            ...
            >
              ...
              {rows.map((row) => (
                ...
                >
                  ...
                  <Text className="mt-1 text-sm text-muted">
                    {formatMinorAmount(row.spentMinor, currency)}{' '}
                    spent
                    {row.budgetAmountMinor === null
                      ? ''
                  ...
                  {row.remainingMinor !== null ? (
                    ...
                    >
                      {row.remainingMinor < 0
                        ? `${formatMinorAmount(-Number(row.remainingMinor), currency)} over`
                        : `${formatMinorAmount(row.remainingMinor, currency)} left`}
                    </Text>
                  ) : null}
                </Pressable>
              ))}
