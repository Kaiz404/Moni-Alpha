      ...
      <View className="flex-1">
        ...
        >
            ...
            <View className="mt-6 flex-row flex-wrap justify-center gap-2">
              {QUICK_AMOUNTS.map((quickAmount) => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.82}
                  className="min-h-10 rounded-full border border-border bg-card px-4 py-2"
          ...
          <TouchableOpacity
            accessibilityRole="button"
            activeOpacity={0.82}
            className="mt-8 flex-row items-center justify-between rounded-[22px] border border-border bg-card p-4"
